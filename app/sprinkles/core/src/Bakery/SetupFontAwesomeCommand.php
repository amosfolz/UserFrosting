...
class SetupFontAwesomeCommand extends BaseCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->io->write('Please enter your Font Awesome Pro npm Package Token. This will be used to download the neccessary packages.');

        // Ask for Font Awesome authentication key
        $newAuthKey = $this->io->ask('What is Font Awesome Pro npm Package Token?');
